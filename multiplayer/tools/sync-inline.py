...
changed=[]
for name,tag,path in [('arenaWireV113','script','src/arena-wire.js'),('arenaEngineV109','script','src/arena-engine.js'),('adventureClientV109','script','src/arena-client.js'),('adventureV109','style','src/adventure.css'),('soundDesignV111','script','src/game-audio.js'),('uiComfortV111','style','src/ui-comfort.css'),('uiComfortRuntimeV111','script','src/ui-comfort.js'),('battleGuildV114','style','src/battle-guild.css'),('guildPageV114','script','src/guild-page.js'),('battleFeedbackV114','script','src/battle-feedback.js')]:
