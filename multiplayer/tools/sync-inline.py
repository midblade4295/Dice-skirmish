#!/usr/bin/env python3
"""Maintain the shared v109+ inline modules WITHOUT regenerating from an older game.
...
changed=[]
for name,tag,path in [('arenaEngineV109','script','src/arena-engine.js'),('adventureClientV109','script','src/arena-client.js'),('adventureV109','style','src/adventure.css')]:
